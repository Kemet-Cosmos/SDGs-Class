      ...
      <div className=" flex flex-col lg:flex-row gap-10 mt-20 ">
        <div className="w-full lg:w-2/4 pl-10 space-y-5 overflow-hidden">
          <motion.div {...FadeLeft} {...ViewPort} className="relative text-lg">
            ...
            noticed Earth is running a fever. Since the late 19th century, the
            planet’s average surface temperature has risen by about{" "}
            ...
            activities like burning fossil fuels, cutting forests, and
            industrial pollution have released vast amounts of greenhouse gases
            into the atmosphere, trapping heat like a thick blanket.
          </motion.div>
          ...
          <motion.div {...FadeLeft} {...ViewPort}>
            ...
            <span className="font-semibold"> 279 billion tons </span> of ice
            every year. Down south, Antarctica is shedding{" "}
